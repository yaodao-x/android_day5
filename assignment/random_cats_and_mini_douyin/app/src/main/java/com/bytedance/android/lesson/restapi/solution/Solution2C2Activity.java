        ...
        retrofit.create(IMiniDouyinService.class).createVideo("16231219", "xujunpeng", coverImage, video).enqueue(new Callback<PostVideoResponse>() {
            ...
            public void onResponse(Call<PostVideoResponse> call, Response<PostVideoResponse> response) {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(Solution2C2Activity.this, "upload success", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        ...
        retrofit.create(IMiniDouyinService.class).FeedResponse().enqueue(new Callback<FeedResponse>() {
            ...
            public void onResponse(Call<FeedResponse> call, Response<FeedResponse> response) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(Solution2C2Activity.this, "fetchfeed success", Toast.LENGTH_SHORT).show();
                    }
                });
            ...
            public void onFailure(Call<FeedResponse> call, Throwable t) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(Solution2C2Activity.this, "fetchfeed fail", Toast.LENGTH_SHORT).show();
                    }
                });
                resetRefreshBtn();
            }
